...
public:
    ...
    /**
     * Start listening with the default wake/chat listening mode.
     * Intended for dev prompt injection paths that emulate wake-word chat,
     * not for manual press-and-hold semantics.
     */
    void StartListeningDefaultMode();
...
private:
    ...
    void MarkSpeakingProgress();
    void ClearSpeakingWatchdog();
    void CheckSpeakingWatchdog();
    void RecoverFromSpeakingTimeout(int64_t now_us, int64_t start_us, int64_t progress_us);
